...
<%@page import="com.foodordering.cart.CartDAO"%>
...
<html>
    ...
    <%
        ...
        List<Order> allOrder = (List<Order>) request.getAttribute("theOrder");
                                ...
                                <td colspan="2">
                                    <div class="row">
                                        <div class="one-half column">
                                            ...
                                            <textarea class="u-full-width" name="txtaddress" id="myBtn" cols="30" rows="10"></textarea>

                                            <button  type="button" class="button-primary" onclick="defaultAddress('<%= profile.getAddress()%>')">Default Address</button>
